...
#define BUILD_HOST              "Linux 4.15.0-29-generic x86_64"

/** Date and time for build */
#define BUILD_TIME              "Wed Jul 25 15:36:23 EDT 2018"

/** User doing build */
#define BUILD_USER              "btreece@LoscheLab [CMAKE]"

/** CPU vendor for build host */
#define BUILD_CPU_VENDOR        "GenuineIntel"

/** CPU brand for build host */
#define BUILD_CPU_BRAND         "Intel(R) Xeon(R) CPU E5-2630 v3 @ 2.40GHz"
...
#define BUILD_C_COMPILER        "/usr/bin/cc GNU 7.3.0"

/** C compiler flags used to build */
#define BUILD_CFLAGS            " -march=core-avx2 -pthread   -Wundef -Wextra -Wno-missing-field-initializers -Wno-sign-compare -Wpointer-arith -Wall -Wno-unused -Wunused-value -Wunused-parameter  -O3 -DNDEBUG -funroll-all-loops -fexcess-precision=fast  -Wno-array-bounds "

/** C++ compiler flags used to build, or empty string if no C++ */
#define BUILD_CXX_COMPILER      "/usr/bin/c++ GNU 7.3.0"

/** C++ compiler flags used to build */
#define BUILD_CXXFLAGS          " -march=core-avx2 -pthread  -std=c++0x  -Wundef -Wextra -Wno-missing-field-initializers -Wpointer-arith -Wall -Wno-unused-function  -O3 -DNDEBUG -funroll-all-loops -fexcess-precision=fast  -Wno-array-bounds "

/** Installation prefix (default location of data files) */
#define CMAKE_INSTALL_PREFIX    "/Archival/gromacs/install"

/** Source directory for the build */
#define CMAKE_SOURCE_DIR        "/Archival/gromacs/gmx_mpi_instantaneous_fixed"

/** Binary directory for the build */
#define CMAKE_BINARY_DIR        "/Archival/gromacs/gmx_mpi_instantaneous_fixed/build"
